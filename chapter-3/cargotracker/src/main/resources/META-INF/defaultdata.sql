### Data to ensure Routing works fine ->
	insert VOYAGE (VOYAGEID,voyage_number) values(3,'0100S');
insert VOYAGE (VOYAGEID,voyage_number) values(4,'0101S');
insert VOYAGE (VOYAGEID,voyage_number) values(5,'0102S');
